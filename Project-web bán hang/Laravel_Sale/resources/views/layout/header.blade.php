                ...
                <div class="beta-comp">
                    ...
                    <div class="cart">
                        ...
                        <div class="beta-dropdown cart-body">
                            ...
                            <div class="cart-item">
                                <a class="cart-item-delete" href="{{ route('banhang.delete',$product['item']['id'])}}"><i class="fa fa-times"></i></a>
                                <div class="media">
                            ...
                            <div class="cart-caption">
                                <div class="cart-total text-right">Subtotal: <span class="cart-total-value"> {{ (Session('cart')->totalPrice)}}đ</span></div>
